...
const ExtractionEngine_1 = require("@application/ExtractionEngine");
...
describe('ExtractionEngine', () => {
    ...
    beforeEach(() => {
        rules = [
            {
                ruleId: 'rule-1',
                fieldName: new ExtractionFieldName_1.ExtractionFieldName('customerName'),
            ...
            {
                ruleId: 'rule-2',
                fieldName: new ExtractionFieldName_1.ExtractionFieldName('invoiceAmount'),
        ...
        engine = new ExtractionEngine_1.ExtractionEngine(rules);
    });
    describe('extract', () => {
        it('should successfully extract a value with sources', () => {
            const result = engine.extract('customerName', 'Acme Corp', [
                {
                    documentReference: {
                        documentId: 'doc-1',
        ...
        it('should track extraction in audit trail', () => {
            engine.extract('customerName', 'Test', [
                {
                    documentReference: {
                        documentId: 'doc-1',
                        fileName: 'test.pdf',
...
describe('ProvenanceAuditor', () => {
    it('should record audit entries with timestamps', () => {
        const auditor = new ExtractionEngine_1.ProvenanceAuditor();
        auditor.record({
            action: 'extract',
            field: 'test',
            result: 'success',
...
//# sourceMappingURL=ExtractionEngine.test.js.map