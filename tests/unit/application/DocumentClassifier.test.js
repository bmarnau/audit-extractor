...
const DocumentClassifierImpl_1 = require("@application/classification/DocumentClassifierImpl");
describe('FeatureBasedClassifier', () => {
    let classifier;
    beforeEach(() => {
        classifier = new DocumentClassifierImpl_1.FeatureBasedClassifier();
    });
    describe('getSupportedTypes', () => {
        it('should return all supported types', () => {
            const types = classifier.getSupportedTypes();
            expect(types).toContain(DocumentClassifierImpl_1.DocumentTypeEnum.INVOICE);
            expect(types).toContain(DocumentClassifierImpl_1.DocumentTypeEnum.CONTRACT);
            expect(types).toContain(DocumentClassifierImpl_1.DocumentTypeEnum.RESUME);
            expect(types).toContain(DocumentClassifierImpl_1.DocumentTypeEnum.EMAIL);
            expect(types).toContain(DocumentClassifierImpl_1.DocumentTypeEnum.REPORT);
            expect(types).toContain(DocumentClassifierImpl_1.DocumentTypeEnum.UNKNOWN);
        });
    });
    describe('classify', () => {
        it('should classify invoice document', async () => {
            ...
            expect(result.documentType).toBe(DocumentClassifierImpl_1.DocumentTypeEnum.INVOICE);
        ...
        it('should classify contract document', async () => {
            ...
            expect(result.documentType).toBe(DocumentClassifierImpl_1.DocumentTypeEnum.CONTRACT);
            expect(result.confidence).toBeGreaterThan(0);
            expect(result.confidence).toBeLessThan(1.0);
        });
        it('should classify resume document', async () => {
            ...
            expect(result.documentType).toBe(DocumentClassifierImpl_1.DocumentTypeEnum.RESUME);
            expect(result.confidence).toBeGreaterThan(0);
        });
        it('should classify email document', async () => {
            const emailDoc = {
                ...
                metadata: {
                    ...
                    size: 500,
                    uploadedAt: new Date(),
                    format: models_1.DocumentFormat.UNKNOWN,
                    ocrApplied: false,
                },
                chunks: [
                    {
            ...
            expect(result.documentType).toBe(DocumentClassifierImpl_1.DocumentTypeEnum.EMAIL);
            expect(result.confidence).toBeGreaterThan(0);
        });
        it('should classify report document', async () => {
            ...
            expect(result.documentType).toBe(DocumentClassifierImpl_1.DocumentTypeEnum.REPORT);
            expect(result.confidence).toBeGreaterThan(0);
        });
        it('should classify ambiguous document as UNKNOWN', async () => {
            ...
            expect(result.documentType).toBe(DocumentClassifierImpl_1.DocumentTypeEnum.UNKNOWN);
        });
    });
...
//# sourceMappingURL=DocumentClassifier.test.js.map